...
public class MainLista07 {
	public static void main(String[] args) {
		...
		atendimentos.add(new AtendimentoEmergencia(LocalDate.now(), "Atendimento emergência", animal, ((Veterinario) pessoas.get(0)), 0));
		atendimentos.add(new AtendimentoRetorno(LocalDate.now(), "Atendimento de retorno", animal, ((Veterinario) pessoas.get(0)), null));
